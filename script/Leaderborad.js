...
leaderboardState.prototype = {
    ...
    create: function(){
        ...
        $.ajax({
            ...
            data: {'name':"jj",'userName':game.global.playerName, 'score':game.global.score, 'artistName':game.global.artistName},
            dataType: "json",
...
this.game.state.start('Menu');
        ...
        showScore: function(){
            ...
            var welcome = playerScore = this.add.text(this.world.centerX,170,'Welcome - '+this.game.global.playerName,this.textStyle);
            welcome.anchor.setTo(0.5,0.5);     
            playerScore = this.add.text(this.world.centerX,250,'Highscore - '+localStorage.getItem('highscore'),this.textStyle);
            playerScore.anchor.setTo(0.5,0.5);
            
            var currentScore = this.add.text(this.world.centerX,320,'Your Score - '+game.global.score,this.textStyle);
